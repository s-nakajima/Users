 ...
 */
	public function testDownloadGet() {
		...
		$this->_mockForReturn(
			'UserAttributes.UserAttribute', 'getUserAttributesForLayout', $userAttribute, 'any'
		);

		//テスト実行
		$this->_testGetAction(
			array('action' => 'download', 'key' => $userId, 'avatar', 'thumb'),
			null, null, 'view'
		);
 ...
 */
	public function testOthers($data, $expectedDisplay) {
		...
		$userAttribute = $this->__getUserAttribute();
		$userAttribute['1']['1']['1']['UserAttributeSetting']['self_public_setting'] = $data['self_public_setting'];
		$userAttribute['1']['1']['1']['UserAttributesRole']['other_readable'] = $data['other_readable'];
		$userAttribute['1']['1']['1']['UserAttributeSetting']['display'] = $data['display'];
		$this->_mockForReturn(
			'UserAttributes.UserAttribute', 'getUserAttributesForLayout', $userAttribute, 'any'
		);
		...
		//テスト実行
		$this->_testGetAction(
			array('action' => 'download', 'key' => $data['user_id'], 'avatar', 'thumb'),
			null, null, 'view'
		);
